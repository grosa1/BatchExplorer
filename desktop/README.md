...
![Account view](../docs/desktop/images/account-home.png)
![Job view](../docs/desktop/images/job-home.png)
...
* To build Batch Explorer yourself or to explore development guidelines and practices, refer to [the developer docs](../docs/README.md)
